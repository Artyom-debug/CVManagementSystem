...
public sealed class RemoveCVLikeCommandValidator : AbstractValidator<RemoveCVLikeCommand>
{
...
internal sealed class RemoveCVLikeCommandHandler : IRequestHandler<RemoveCVLikeCommand, Result>
{
    private readonly IApplicationDbContext _context;
    private readonly IUser _user;

    public RemoveCVLikeCommandHandler(IApplicationDbContext context, IUser user)
    {
        _context = context;
        _user = user;
    }

    public async Task<Result> Handle(RemoveCVLikeCommand request, CancellationToken cancellationToken)
    {
