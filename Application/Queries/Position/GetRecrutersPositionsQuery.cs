...
public sealed record GetRecruiterPositionsQuery(int Page = 1, int PageSize = 30) : IRequest<PageResult<PositionDto>>;
...
internal sealed class GetRecruiterPositionsQueryHandler : IRequestHandler<GetRecruiterPositionsQuery, PageResult<PositionDto>>
{
    ...
    public async Task<PageResult<PositionDto>> Handle(GetRecruiterPositionsQuery request, CancellationToken cancellationToken)
    {
