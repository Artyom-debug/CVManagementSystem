        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxProjectCount = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Positions_MaxProjectCount_NonNegative", "\"MaxProjectCount\" >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Option = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    AttributeId = table.Column<Guid>(type: "uuid", nullable: false),
                    AttributeType = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    Operator = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    Value = table.Column<string>(type: "jsonb", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PositionAccessRules", x => new { x.PositionId, x.Id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_PositionAttributes_DisplayOrder_NonNegative", "\"DisplayOrder\" >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    PositionId = table.Column<Guid>(type: "uuid", nullable: false),
                    TagName = table.Column<string>(type: "character varying(100)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PositionTags", x => new { x.PositionId, x.TagName });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PositionTags_Tags_TagName",
                        column: x => x.TagName,
                        principalTable: "Tags",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageValue = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    ...
                    DropdownOptionId = table.Column<Guid>(type: "uuid", nullable: true),
                    ProfileId = table.Column<Guid>(type: "uuid", nullable: false),
                    AttributeId = table.Column<Guid>(type: "uuid", nullable: false),
                    Version = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProfileAttributeValues_Attributes_AttributeId",
                        column: x => x.AttributeId,
                        principalTable: "Attributes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProfileAttributeValues_Profiles_ProfileId",
                        column: x => x.ProfileId,
                        principalTable: "Profiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecruterId = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: false),
                    Version = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttributeOptions_AttributeId_Option",
                table: "AttributeOptions",
                columns: new[] { "AttributeId", "Option" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Attributes_Category_Name",
                table: "Attributes",
                columns: new[] { "Category", "Name" });

            migrationBuilder.CreateIndex(
                name: "IX_Attributes_Name_Trigram",
                table: "Attributes",
                column: "Name")
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attributes_Name_Unique",
                table: "Attributes",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CVs_PositionId_Status_CreatedAt",
                table: "CVs",
                columns: new[] { "PositionId", "Status", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Likes_CVId_RecruterId",
                table: "Likes",
                columns: new[] { "CVId", "RecruterId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PositionAccessRules_PositionId_AttributeId",
                table: "PositionAccessRules",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PositionAttributes_PositionId_DisplayOrder",
                table: "PositionAttributes",
                columns: new[] { "PositionId", "DisplayOrder" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PositionTags_TagName",
                table: "PositionTags",
                column: "TagName");

            migrationBuilder.CreateIndex(
                name: "IX_ProfileAttributeValues_AttributeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfileAttributeValues_ProfileId_AttributeId",
                table: "ProfileAttributeValues",
